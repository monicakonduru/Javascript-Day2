...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center p-8">
      <h1 className="text-5xl font-bold mb-6">To Do List</h1>

      <div className="bg-gray-200 p-5 rounded-lg flex flex-col">
            ...
            {todos.map((todo) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-red-500 text-xl hover:scale-110 transition-transform duration-200"
                >
                  X
                </button>
              </div>
